...
class Betting(BaseEndpoint):
    ...
    def place_bet(self, sport_id, event_id, line_id, period_number, bet_type, stake, team=None, side=None,
                  alt_line_id=None, win_risk_stake=WinRiskType.Risk, accept_better_line=Boolean.TRUE,
                  odds_format=OddsFormat.Decimal, is_max_stake_bet=None, pitcher1_must_start=None,
    ...
    def place_special_bet(self, line_id, special_id, contestant_id, stake, win_risk_stake=WinRiskType.Risk,
                          odds_format=OddsFormat.Decimal, accept_better_line=Boolean.TRUE, session=None):
        """
